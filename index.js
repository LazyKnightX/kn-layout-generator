...
function ParseLevelTable(filepath, destpath, width = 16, height = 16, horizontal = 3) {
    ...
    */
    ...
    function generate_jass() {
        const jass = []
        jass.push(`private function updateLayout takes integer id returns nothing`)
        ...
        jass.push(`    call BJDebugMsg("Unknown Layout: " + I2S(id))`)
        jass.push(`endfunction`)
...
module.exports = { LoadTable, ParseLevelTable }
